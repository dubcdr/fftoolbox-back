...
export class EspnWrsScrape extends EspnTools {
  public year = 2017;
  public projSeasStatUrl = 'http://games.espn.com/ffl/tools/projections?slotCategoryId=4';
