...
import { FProsScrape } from './fprosScrape';
import { Fftoolbox } from './../fftoolbox';
import * as _ from 'lodash';

export class FprosAdpScrape extends FProsScrape {
  public year = 2017;
  ...
  public async getAdp(): Promise<Array<Fftoolbox.models.IAvgDraftPos>> {
    ...
    for (let result of scrapeResults) {
      ...
      result.fantasyProsId = this.getOutletIdFromLink(result.fantasyProsId);
...
let adpScrape = new FprosAdpScrape();
